...
class QuizxelSeshTest {
    ...
    void processQueue_should_advance_current_stage_to_main() {
        ...
        this.sesh.processQueue();
        Assertions.assertEquals(SeshStage.MAIN, this.sesh.getCurrentStage());
        Assertions.assertEquals(QuizxelHostMainStageState.class, this.sesh.getHostState().getClass());
        Assertions.assertEquals(QuizxelControllerMainStageState.class, this.sesh.getControllerState().getClass());
    }
